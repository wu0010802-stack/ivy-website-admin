...
<section class="studio-hero" aria-labelledby="home-title"><div class="container studio-hero-grid">
 ...
 </div><div class="container studio-media"><div id="video-controls" hidden><button type="button" id="video-play" aria-controls="hero-video"><span class="sr-only">播放影片</span></button></div></div></section>
