...
if (direction === 'a') {
  ...
  panel.innerHTML = `<div class="panel-intro"><h1>探索常春藤</h1><span class="intro-line" aria-hidden="true"></span></div>${navigation()}${campusLinks()}<div class="institution-socials"><span>機構社群</span><a href="https://www.facebook.com/ivykid" target="_blank" rel="noopener noreferrer">${icon('facebook')}機構粉絲專頁${icon('arrow-up-right')}</a></div>${phone(window.menuCampuses[0])}`;
} else {
