...
{const place=new URLSearchParams(location.search).get('pill');if(['center','left','right','split','split-mini'].includes(place))document.documentElement.dataset.pill=place;}
...
function positionPanel(){
 ...
 const width=Math.max(rect.width,split&&compact?420:0);
 ...
 panel.style.top=(rect.bottom-base.top+(compact?-1:8))+'px';
