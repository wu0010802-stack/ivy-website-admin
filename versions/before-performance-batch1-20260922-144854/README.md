...
依使用者「走 A」定案，Nuxt 共用頁尾改為深森林綠底、米白文字及暖金點綴，沿用現有排版、文案與五校導覽。首頁消息區維持暖白漸退，再接深綠頁尾；色票限定在 `SiteFooter.vue`，不更動全域品牌色與凍結原型。三案比較留存於 `design/footer-colour-directions-20260922/`，尚未部署。
