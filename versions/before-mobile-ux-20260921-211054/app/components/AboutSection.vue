...
@media(max-width:760px){
  ...
  .belief-copy-toggle{display:inline-flex;align-items:center;min-height:44px;margin-top:8px;padding:4px 0;border:0;border-bottom:1px solid currentColor;background:transparent;color:var(--green);font-size:.9375rem}
}
