...
try{
 ...
 engine=createEntranceCurtain($('#curtain'),$('#stage'),'../../web/public/assets/ivy-30th-anniversary-projection.png',{valance:params.get('valance')==='1',digitFontUrl:'../../web/public/assets/fonts/lineseed-eb.woff2'});
 await engine.ready;
