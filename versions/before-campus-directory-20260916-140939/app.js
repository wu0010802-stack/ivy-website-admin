...
<section class="section studio-about" id="about"><div class="container"><div class="studio-intro"><div class="studio-intro-copy"><span class="eyebrow">關於常春藤</span><h2 class="section-title">在地近三十年，<br>把每個孩子，放在心上。</h2><p class="section-copy">在高雄深耕近三十年，常春藤以用心陪伴累積家長的信任。歐式城堡裡，有一起讀的故事、自在探索的日常，也有老師溫柔的守候。</p><p class="section-copy">我們相信，教育是「生命影響生命」。用愛與關懷理解每個孩子的不同，在快樂、健康的環境裡，陪孩子依自己的步調成長，帶著自信與好奇，走向更大的世界。</p><a class="text-link" href="#/home/campuses">認識五所校園</a></div><figure class="studio-intro-photo">${img('about-curious','常春藤的孩子在教室裡指著剛發現的東西')}</figure></div>
</div></section>
${dayExperience()}
