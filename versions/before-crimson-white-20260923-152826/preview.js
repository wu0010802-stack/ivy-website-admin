...
try{
 ...
 engine=createEntranceCurtain($('#curtain'),$('#stage'),'../../web/public/assets/ivy-30th-anniversary-projection.png',{digitFontUrl:'../../web/public/assets/fonts/oswald-700-leader.woff2',sheenTone:params.get('sheen')==='crimson'?'crimson':'rose',leaderLamp:params.get('lamp')==='white'?'white':'warm'});
 await engine.ready;
