...
export const ENTRANCE_DURATION = 3400
...
function deformMaterial(material: THREE.Material, uniforms: ClothUniforms, textile = false) {
...
export function createEntranceCurtain(canvas: HTMLCanvasElement, host: HTMLElement) {
