...
async function init() {
  ...
  campuses.forEach((c, i) => {
    ...
    tab.setAttribute('aria-controls', 'campus-details'); tab.dataset.number = String(i + 1).padStart(2, '0'); tab.innerHTML = `<img class="tab-art" src="../../web/public/assets/campus-line-art-${escapeHtml(c.key)}.webp" width="120" height="80" alt="" aria-hidden="true"><span>${escapeHtml(c.name)}</span>`;
