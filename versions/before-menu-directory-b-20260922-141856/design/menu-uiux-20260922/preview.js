...
if (direction === 'a') {
  ...
  panel.innerHTML = `<div class="panel-intro"><h1>從這裡，認識常春藤。</h1><span class="intro-dot" aria-hidden="true"></span></div>${navigation()}${campusLinks()}${phone(window.menuCampuses[0])}`;
} else {
